...
class GRID2DEMAND:
    ...
    def net2grid(self, *,
        ...
        # If cell dimensions are specified, override the default block counts
        # Note: num_x/y_blocks have priority, so we need to zero them out when using cell dimensions
